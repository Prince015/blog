...
export const uploadImage = async (file) => {
    ...
    fdata.append("upload_preset", "my_store");//may be profile image
    // complaintlodgeriitrchat
    ...
    const { data } = await axios.post(//
        `https://api.cloudinary.com/v1_1/${process.env.REACT_APP_UPLOAD_API}/image/upload`,
        fdata,
        config
    );
