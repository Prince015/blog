...
import PrinceBlog from "../../assets/logo1.png";
...
const MobileMenu = ({ data,history,closeModal }) => {
    return (
        <div className="mobilemenu mobile_pf" onClick={closeModal}>
            ...
            {data && 
                <div className="menu_item" onClick={()=>window.location.href=`/${data.username}`}>
        ...
        <div className="header">
            ...
            <div className="mainheader_wrapper">
                <div className="header_left">
                    <a href="/">
                        <div className="logo">
                            <img src={PrinceBlog} alt="" id="logo" />
                        </div>
                    </a>
                ...
                <div className="header_right">
                    ...
                    <div className="profile">{data ?
                        <Tooltip title="Your profile 😃️" TransitionComponent={Zoom} arrow>
                            <Avatar alt="" onClick={()=>window.location.href=`/${data.username}`}/>
                        </Tooltip>
