exports.generateTemplate = ({type,data})=>{
    ...
    switch(type){        
        case "recover-account":
            ...
            template.html=`<h4>Hello ${data.user.fullname}</h4>OTP to recover your account is <b>${data.OTP}.</b><br>This OTP will expire in <b>5 minutes</b>.<br>Wishing you the best for your blogging experience,<br><br>Regards<br>Team Prince_logger<br>India`;;
            return template;
        case "report_story":
